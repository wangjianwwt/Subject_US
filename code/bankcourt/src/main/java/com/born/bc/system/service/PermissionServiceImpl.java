...
import com.born.bc.system.entity.PermissionLinkDto;
import com.born.bc.system.service.api.PermissionServiceApi;
...
public class PermissionServiceImpl implements PermissionServiceApi {
	...
	public ResultJson getPermissionByRole(String roleId) {
		try {
			...
			//初始化 返回集合
			List<PermissionLinkDto> resultList = new ArrayList<>(allPermissionList.size());
