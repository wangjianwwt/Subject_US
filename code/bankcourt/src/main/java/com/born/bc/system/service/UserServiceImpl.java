...
import com.born.bc.system.dao.PermissionMapper;
import com.born.bc.system.dao.RoleMapper;
import com.born.bc.system.dao.UserMapper;
import com.born.bc.system.entity.ChangePwdVo;
import com.born.bc.system.entity.Role;
import com.born.bc.system.entity.User;
import com.born.bc.system.entity.UserRoleRelation;
...
public class UserServiceImpl implements UserServiceApi {
	...
	public HashSet<String> getRoleByLoginNameCache(String loginName) {
		...
		LogUtils.debug("cache角色信息：", roleStr);
	...
	public void layout(User user) {
		...
		// 清除缓存中的用户信息，要求用户重新登录
		redisClientTemplate.del(user.getUserToken());
	}
