package com.born.bc.system.service;
...
import com.born.bc.system.dao.RoleMapper;
import com.born.bc.system.entity.Permission;
import com.born.bc.system.entity.Role;
import com.born.bc.system.entity.RoleParamVO;
import com.born.bc.system.entity.RolePermissionRelation;
import com.born.bc.system.service.api.RoleServiceApi;
...
public class RoleServiceImpl implements RoleServiceApi {
        ...
        try {
            ...
            if(!CollectionUtils.isEmpty(permissionList)){
            	for(Role rl : list){
            		...
            		List<Permission> thisPermissionList = new ArrayList<>(7);
	...
	public ResultJson updateRoleLinkedPermissions(RoleParamVO vo) throws BussinessException {
        ...
        // 组装参数
        List<Permission> permissions = new ArrayList<>(permissionArray.length);
...
//            return ResultJson.buildError("角色未关联权限!");
//        }
//        for (Permission permission : permissions) {
//            if (StringUtils.isEmpty(permission.getId())) {
//                return ResultJson.buildError("被关联的权限缺乏主键!");
//            }
//        }
        return null;
    }
